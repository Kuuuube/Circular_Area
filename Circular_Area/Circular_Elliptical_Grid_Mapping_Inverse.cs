...
{
    [PluginName("Circular Elliptical Grid Mapping Inverse")]
    public class Circular_Elliptical_Grid_Mapping_Inverse : CircularBase
    {
        public static string Filter_Name = "Circular Elliptical Grid Mapping Inverse";
        ...
        public static Vector2 SquareToCircle(Vector2 input)
        {
            ...
            var circle = new Vector2(
                (float)(x * Math.Sqrt(1 - (y2 / 2))),
                (float)(y * Math.Sqrt(1 - (x2 / 2)))
            );
