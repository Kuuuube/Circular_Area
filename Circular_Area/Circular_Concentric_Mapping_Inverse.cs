...
namespace Circular_Area
{
    ...
    public class Circular_Concentric_Mapping_Inverse : IFilter
    {
        ...
        public static Vector2 CircleToSquare(Vector2 input)
        {
            ...
            if (absx >= absy)
            {
                ...
                x * MathF.Cos((MathF.PI / 4) * (y / x)),
                x * MathF.Sin((MathF.PI / 4) * (y / x))
                );
            ...
            {
                var circle = new Vector2(
                y * MathF.Cos((MathF.PI / 2) - ((MathF.PI / 4) * (x / y))),
                y * MathF.Sin((MathF.PI / 2) - ((MathF.PI / 4) * (x / y)))
                );
                if ((circle.X >= 0 || circle.X <= 0) && (circle.Y >= 0 || circle.Y <= 0))
                {
                    return new Vector2(
