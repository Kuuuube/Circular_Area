...
namespace Circular_Area
{
    ...
    public class Circular_Concentric_Mapping : IFilter
    {
        ...
        public static Vector2 CircleToSquare(Vector2 input)
        {
            ...
            if (u2 > v2)
            {
                ...
                sgnu * MathF.Sqrt(u2 + v2) * 1,
                sgnu * MathF.Sqrt(u2 + v2) * (4 / MathF.PI * MathF.Atan(v / u))
                );
            ...
            {
                var circle = new Vector2(
                sgnv * MathF.Sqrt(u2 + v2) * (4 / MathF.PI * MathF.Atan(u / v)),
                sgnv * MathF.Sqrt(u2 + v2) * 1
                );
                if ((circle.X >= 0 || circle.X <= 0) && (circle.Y >= 0 || circle.Y <= 0))
                {
                    return new Vector2(
