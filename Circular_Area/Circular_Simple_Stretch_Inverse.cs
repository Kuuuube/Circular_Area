...
namespace Circular_Area
{
    ...
    public class Circular_simple_stretch_inverse : IFilter
    {
        ...
        public static Vector2 CircleToSquare(Vector2 input)
        {
            ...
            if (x2 >= y2)
            {
                ...
                sgnx * (x2 / (MathF.Sqrt(x2 + y2))),
                sgnx * (x * y / (MathF.Sqrt(x2 + y2)))
                );
            ...
            {
                var circle = new Vector2(
                sgny * (x * y / (MathF.Sqrt(x2 + y2))),
                sgny * (y2 / (MathF.Sqrt(x2 + y2)))
                );
                if ((circle.X >= 0 || circle.X <= 0) && (circle.Y >= 0 || circle.Y <= 0))
                {
                    return new Vector2(
